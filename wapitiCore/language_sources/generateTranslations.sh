...
rm ../config/language/pt/LC_MESSAGES/wapiti.mo 2> /dev/null
rm ../config/language/zh/LC_MESSAGES/wapiti.mo 2> /dev/null
...
msgfmt pt.po -o ../config/language/pt/LC_MESSAGES/wapiti.mo
msgfmt zh.po -o ../config/language/zh/LC_MESSAGES/wapiti.mo
