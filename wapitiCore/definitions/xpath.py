...
WSTG_CODE = ["WSTG-INPV-09"]

DESCRIPTION = (
    "XPath Injection attacks occur when a web site uses user-supplied information to construct an XPath query "
    "for XML data."
) + " " + (
    "By sending intentionally malformed information into the web site, an attacker can find out how the XML data "
    "is structured, or access data that they may not normally have access to."
)
