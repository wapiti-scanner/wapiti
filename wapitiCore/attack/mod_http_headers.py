...
#This module check the recommendations of security parameters in HTTP headers
class mod_http_headers(Attack):
    ...
    def is_set(self, response: object, header_name, check_list):
        ...
        if header_name not in response.headers:
            ...
            return any(element in response.headers[header_name] for element in check_list)
